...
export const PLANS: PlanCard[] = [
  {
    ...
    features: [
      ...
      "WordPress'e otomatik yayınlama",
...
export const COMPARISON: ComparisonGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "WordPress otomatik yayın", values: [true, true, true] },
      { label: "Planlı yayın takvimi", values: [false, true, true] },
    ],
  },
  {
